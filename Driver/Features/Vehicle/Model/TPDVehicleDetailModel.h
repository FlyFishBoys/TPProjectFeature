...
/*
 ...
 truck_type_id    车型id    string
 truck_length_name    车长name    string
 truck_length_id    车长id    string
 truck_status    车辆状态    string    1 空车/求货中,2 休息
 driver_name    驾驶员姓名    string    备注信息
 driver_mobile    驾驶员手机号    string    备注信息
 driver_truck_version    司机车辆版本号    string
 */

@interface TPDVehicleDetailModel : NSObject
